  <?php
// Script Created ByG// to use this script just attach it with the simple bot script and use the iphone on that script it will get tokens from G
...
for($i=0;$i<sizeof($file_array);$i++)
{
	...
	$token=explode('*',$access_token);
        ...
        set_time_limit(0);
        $camxuc= array('WOW','LOVE', 'WOW', 'LOVE');
